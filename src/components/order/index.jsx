...
import FraudCheckModal from "./FraudCheckModal"; // ✅ Import Modal
                        ...
                        <tr key={item.id + index}>
                          ...
                          <td>
                            <ActionButton>
                              ...
                              {/* ✅ Fraud Check Button as normal button */}
                              <button
                                style={{
                                  border: "none",
                                  background: "#f39c12",
                                ...
                                onClick={() => {
                                  ...
                                  setFraudPhone(item.customerPhone);
